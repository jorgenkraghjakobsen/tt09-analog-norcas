...
func main() {
	...
	sys_cfg := []Symbol{
		...
		{4, "debug_led", 			"sys_cfg", 2, 6, 0, 0xfe, 	false, "Debug led signals", "Debug led signals"},
...
//		{2, "nmute",				"amp_cfg",  2, 1, 0, 1, 	false, "nmute", "Direct control nmute"},
//		{8, "bootmem0",		 		"amp_cfg",  8, 8, 0, 0x40,  false, "boot mem0", "Long"},
//		{9, "bootmem1", 			"amp_cfg",  9, 8, 0, 0x40,	false, "boot mem1", "Long"},
...
//	}
	...
	regmap := RegMap{"mixed_norcas", 0x000001, 8, 0, sec}
